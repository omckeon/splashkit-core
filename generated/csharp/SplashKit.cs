...
namespace SplashKitSDK
{
  public static class SplashKit
  {
    ...
    private static extern __sklib_string __sklib__replace_all__string_ref__string_ref__string_ref(__sklib_string text, __sklib_string substr, __sklib_string new_text);
    ...
    public static string ReplaceAll(string text, string substr, string new_text)
    {
      __sklib_string __skparam__text;
