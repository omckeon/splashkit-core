...
function ReplaceAll(const text: String; const substr: String; const new_text: String): String;
...
function __sklib__replace_all__string_ref__string_ref__string_ref(const text: __sklib_string; const substr: __sklib_string; const new_text: __sklib_string): __sklib_string; cdecl; external;
